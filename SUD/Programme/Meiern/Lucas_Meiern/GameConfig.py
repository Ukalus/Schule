...
class GameConfig:
    ...
    def setup(self):
        ...
        print("\nBitte geben Sie die Namen der Spieler einzeln ein und bestätigen jeden Namen mit einem ENTER. "
              "Um die Spielereingabe zu beenden drücken Sie einfach ENTER.\n")
        while True:
            player_name = input("> ")
            if "" == player_name:
