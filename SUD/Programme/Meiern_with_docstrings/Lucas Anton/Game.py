...
class Game:
    '''Creates a runnable game object(needs to be configured before running)'''
    ...
    def __init__(self, config):
        '''initializes a gameObject based on a config object, also sets the players and dicecup and runs the game'''
    ...
    def play(self):
        '''Runs the game and handles the IO'''
        print("""
        #################################
        # Spielstart #
        #################################
    ...
    def doubt(self, player: Player):
        '''player event to doubt a player'''
